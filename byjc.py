...
if __name__ == "__main__":
    # code to read image
    image = cv.imread('./test/input/challenging-60/45.png', 0)
    # image = cv.imread('./test/input_cany/37.png', 0)
    ...
    # 保存结果
    cv.imwrite("./test/output/Canny/output_image_Original1.png", output_image)
    cv.waitKey(0)
